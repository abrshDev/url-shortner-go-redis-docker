...
1. Clone the repository:
   ```bash
   git clone [https://github.com/abrshDev/url-shortner-go-redis-docker.git](https://github.com/abrshDev/url-shortner-go-redis-docker.git)
